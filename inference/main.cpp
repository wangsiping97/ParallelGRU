...
#include <stdio.h>
#include <getopt.h>
#include "gru_inference_sequential.h"
...
int main(int argc, char** argv) {
    ...
    if (use_gpu) {
        print_cuda_info();
        inference_cuda(num_data, batch_size, window_size, vec_len, hidden_unit, step_size, 
                        h_t, h_t_new, 
                        w_z, w_r, w_h,
                        u_z, u_r, u_h,
                        b_z, b_r, b_h,
    ...
    // using CPU
        ...
        cout << "Using CPU..." << endl;
        inference(num_data, batch_size, window_size, vec_len, hidden_unit, step_size,
                    h_t, h_t_new,
                    w_z, w_r, w_h,
                    u_z, u_r, u_h,
                    b_z, b_r, b_h,
